...
/**
 * Bid is a simple carrier of information about a placed bid. This class can be
 * compared by its natural ordering to determine if one bid beats another one.
 */
public class Bid implements Comparable<Bid>, ConfigurationSerializable {
	...
	public static Bid deserialize(Map<String, Object> map) {
		return new Bid((Merchant) map.get("bidder"), new MoneyAmount(
				map.get("amount")).getDouble());
	}
}
