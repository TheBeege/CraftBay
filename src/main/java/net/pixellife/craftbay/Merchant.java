...
/**
 * This class is an abstract representation of a participant in an auction,
 * either as auctioneer or as bidder. Typical actions are the giving, taking
 * away and checking for availability of items and money. Primary motif for
 * creating this abstraction is to manage both players and The Bank in the same
 * way.
 */
public interface Merchant extends ConfigurationSerializable {
	...
	/**
	 * Check this merchant's inventory for availabilty of an ItemStack.
	 * 
	 * @param lot
	 *            the ItemStack
