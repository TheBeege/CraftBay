...
/**
 * Represents an Item in somebody's hand. You do not want to keep an instance of
 * this class around before calling take().
 */
public class HandItem extends RealItem {
	...
	/**
	 * Same effect as superclass, but take care that the item in hand is
	 * considered first.
	 */
	@Override
