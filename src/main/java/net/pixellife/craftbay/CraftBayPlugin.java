...
import net.pixellife.craftbay.chat.BukkitChat;
import net.pixellife.craftbay.chat.ChatPlugin;
import net.pixellife.craftbay.command.AuctionCommand;
import net.pixellife.craftbay.locale.Color;
import net.pixellife.craftbay.locale.Language;
...
public class CraftBayPlugin extends JavaPlugin {
	...
	public void onEnable() {
		...
		if (!setupEconomy()) {
			getLogger().severe(
					"Failed to setup economy. CraftBay is not enabled!");
			setEnabled(false);
			return;
		}
